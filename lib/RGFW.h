...
// the following lines are used by the hs-game package by Andromeda
#ifndef RGFW_HS             // Andromeda: added guards                    
#define RGFW_HS
...
#define RGFW_NATIVE_HEADER
	...
	#ifdef RGFW_X11
    // the following lines added by Andromeda to resolve name conflict with Time
    #define Time X11Time
		#include <X11/Xlib.h>
    #undef Time
		#include <X11/Xutil.h>
